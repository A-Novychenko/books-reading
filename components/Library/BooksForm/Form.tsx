...
interface AddBookFormProps {
  handleBookUpdate: (bookUpdated: boolean) => void;
}

export const AddBookForm: FC<AddBookFormProps> = ({ handleBookUpdate }) => {
...
function handleBookUbdate(arg0: boolean) {
